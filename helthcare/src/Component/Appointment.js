    ...
    return (
        <Paper style={{ padding: '20px', marginTop: '20px' }}>
            <div className='flex px-2'>
                <Link to='/Appointments'><Typography className='  px-4 bg-gray-200 rounded-2xl' variant="h6" gutterBottom>
                    New Appointments
                </Typography>
                </Link>
                <Link to='/Appointments/completed'>
                    <Typography className='ml-4 px-4 bg-gray-200 rounded-2xl ' variant="h6" gutterBottom>
